      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 lg:grid-cols-[1.4fr_0.8fr_0.8fr_1fr] lg:px-8">
        ...
        <div>
          ...
          <p className="mt-5 max-w-md text-sm leading-7 text-slate-400">
            {SITE_TAGLINE}. NB Prompts helps creators with AI prompts, blogging resources, image tools, SEO tips, and modern online creator workflows.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 space-y-3">
            <Link href="/" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Home
            </Link>
            <Link href="/blogs" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Blogs
            </Link>
            <Link href="/about" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              About Us
            </Link>
            <Link href="/contact" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Contact Us
            </Link>
            <Link href="/author" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Author & Team
            </Link>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 space-y-3">
            <Link href="/category/ai-prompts" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-orange-400">
              AI Prompts
            </Link>
            <Link href="/category/ai-tools" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-orange-400">
              AI Tools
            </Link>
            <Link href="/category/earn-money" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-orange-400">
              Earn Money
            </Link>
            <Link href="/courses/web-development-with-ai" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-orange-400">
              AI Courses
            </Link>
          </div>
        </div>
        ...
        {/* LEGAL */}
        <div>
          <h3 className="text-lg font-bold text-white">Legal & Compliance</h3>
          <div className="mt-5 space-y-3">
            <Link href="/privacy-policy" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Privacy Policy
            </Link>
            <Link href="/terms-and-conditions" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Terms & Conditions
            </Link>
            <Link href="/disclaimer" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Disclaimer
            </Link>
            <Link href="/cookie-policy" className="block text-sm text-slate-400 transition-all duration-300 hover:translate-x-1 hover:text-cyan-400">
              Cookie Policy
            </Link>
