...
const CONTACT_EMAIL = "contact@newbananaprompts.in";
...
export default function ContactPage() {
  return <section className="mx-auto max-w-4xl space-y-8">
    ...
    <div className="site-panel space-y-5 rounded-xl px-5 py-6 sm:px-8 sm:py-8"><h2 className="theme-text-primary text-xl font-bold">Contact information</h2><div className="theme-text-secondary space-y-2 text-sm leading-7"><p><strong>Email:</strong> <a className="theme-kicker font-semibold hover:underline" href={`mailto:${CONTACT_EMAIL}`}>{CONTACT_EMAIL}</a></p><p><strong>Location:</strong> Saket, Lakhimpur Kheri, Uttar Pradesh 262701, India</p></div><p className="theme-text-secondary text-sm leading-7">Include a clear subject and, for a correction or copyright concern, the URL of the relevant page.</p><a href={`mailto:${CONTACT_EMAIL}?subject=NB%20Prompts%20inquiry`} className="theme-button inline-flex min-h-11 items-center rounded-sm px-5 py-2 text-sm font-semibold">Open your email app</a></div>
