...
export const metadata: Metadata = {
  ...
  description: `Read the Terms and Conditions for using ${SITE_NAME}. Learn about user rights, intellectual property, prompt usage, and terms of service.`,
  alternates: {
    ...
    <article className="mx-auto max-w-4xl space-y-6">
      ...
      <div className="site-panel rounded-2xl px-6 py-8 sm:px-10 sm:py-10 space-y-6">
        ...
        <section className="space-y-3">
          ...
          <p className="theme-text-secondary text-sm leading-7">
            All AI prompts, image prompts, articles, tutorials, and guides published on {SITE_NAME} are provided for educational, inspirational, and informational purposes. You are permitted to copy and use the individual AI prompts for generating personal or commercial artwork. However, bulk copying, scraping, redistributing, or re-selling our compiled database of prompts or articles on other websites or apps without explicit written permission is strictly prohibited.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="theme-text-secondary text-sm leading-7">
            Except for the copyable AI prompt strings, all original content, branding, logos, graphics, guides, courses, and layout structures on {SITE_NAME} are the intellectual property of Shobhit Verma and {SITE_NAME}. You may not copy, reproduce, or replicate the site's designs or proprietary content.
          </p>
        </section>

        <section className="space-y-3">
          <h2 className="theme-text-primary text-xl font-bold">4. Disclaimer of Warranties (Exam Guides & Tools)</h2>
          <p className="theme-text-secondary text-sm leading-7">
            Our tutorials, courses, tools, and competitive examination guides are provided "as is" without warranties of any kind, express or implied. {SITE_NAME} does not guarantee that the AI tools described will remain free, accessible, or produce specific results, nor do we guarantee that our exam preparation materials represent exact upcoming examination layouts or official notifications. We are not liable for any direct or indirect damages arising from the use of our guides or AI prompts.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="theme-text-secondary text-sm leading-7">
            If you have any questions or feedback regarding these Terms and Conditions, please contact us via our <Link href="/contact" className="theme-kicker hover:underline">Contact Page</Link> or email us at <span className="theme-text-primary font-semibold">shoverashop@gmail.com</span>.
          </p>
        </section>
      </div>
    </article>
